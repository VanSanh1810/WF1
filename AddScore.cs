...
namespace WindowsFormsApp1
{
    public partial class AddScore : Form
    {
        ...
        private void AddScore_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'qLSVDBDataSet2.Course' table. You can move, or remove it, as needed.
            this.courseTableAdapter.Fill(this.qLSVDBDataSet2.Course);
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            score_tbx.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString().Trim();
